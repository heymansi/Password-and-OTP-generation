...
public class PasswordGenerator {
	...
	// write your code here
        ...
        length = sc.nextInt();
        if(length <8)                       //condition for checking length is greater than 8
        {
    ...
    public static char[] password(int len)         //method or password generation using given inputs
    {
        ...
        String SmallLetters = CapitalLetters.toLowerCase();     //to convert all uppercase letters to lower case letters
        String numbers = "1234567890";
        String symbol = "!@#$%^&*_+-<>/?";
        //strong password has Capital letters, small letters, symbols and numbers
